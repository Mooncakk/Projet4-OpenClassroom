...
class AjoutJoueurs():
  ...
  def __init__(self):
    ...
    if path == False:
      with open(self.filename, 'w') as file:
        json.dump(liste_de_joueurs, file, indent = 4)
    else:
      pass
  ...
  def infos_joueur(self):
    ...
    self.classement = input(f'Votre classement :\n - ')
 
    infos_joueurs = {'Nom de famille' : self.nom,
                     'Prénom' : self.prenom,
...
class AjoutTournoi():
  ...
  def __init__(self):
    ...
    if path == False:
      with open(self.filename, 'w') as file:
        json.dump(liste_des_tournois, file, indent = 4)
    else:
      pass
